...
bool CLaserOdometry2DNode::setLaserPoseFromTf()
{
  ...
  { 
    ...
    //tf_listener.waitForTransform(base_frame_id, last_scan.header.frame_id, now, ros::Duration(3.0));
    //tf_listener.waitForTransform(base_frame_id, "change", now, ros::Duration(1.0));
    printf("2");
